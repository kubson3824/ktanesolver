...
public enum ModuleType {
	...
	WIRES(false), BUTTON(false), KEYPADS(false), MEMORY(false), SIMON_SAYS(false), MORSE_CODE(false), FORGET_ME_NOT(false), SOUVENIR(false), SONIC_THE_HEDGEHOG(false), ICE_CREAM(false), THE_SCREW(false), YAHTZEE(false), X_RAY(false), BATTLESHIP(false), MINESWEEPER(false), WHOS_ON_FIRST(false), THIRD_BASE(false), VENTING_GAS(true), CAPACITOR_DISCHARGE(
