...
@Service
@ModuleInfo (type = ModuleType.WIRES, id = "wires", name = "Wires", category = ModuleCatalogDto.ModuleCategory.VANILLA_REGULAR, description = "Cut the correct wires based on the rules", tags = {
	"horizontal-wires", "red", "blue", "black", "white", "yellow"})
