...
@Service
@ModuleInfo (type = ModuleType.SWITCHES, id = "switches", name = "Switches", category = ModuleCatalogDto.ModuleCategory.MODDED_REGULAR, description = "Set switches to the correct positions", tags = {
	"logic", "puzzle"})
