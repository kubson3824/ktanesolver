...
public class WordScrambleSolver implements ModuleSolver<WordScrambleInput, WordScrambleOutput> {
    ...
    private static final List<String> VALID_WORDS = Arrays.asList("BANANA", "ATTACK", "DAMAGE", "NAPALM", "OTTAWA", "KABOOM", "BLASTS", "CHARGE", "ARCHER", "CASING", "CANNON", "KEYPAD", "DISARM", "FLAMES", "KEVLAR", "WEAPON", "SAPPER", "MORTAR", "BUTTON", "ROBOTS", "BURSTS", "DEVICE", "ROCKET", "DEFUSE", "WIDGET", "MODULE", "LETTER", "SEMTEX", "PERSON", "WIRING");

    @Override
    public ModuleType getType() {
        return ModuleType.WORD_SCRAMBLE;
    }
    ...
    public SolveResult<WordScrambleOutput> solve(RoundEntity round, BombEntity bomb, ModuleEntity module, WordScrambleInput input) {
        ...
        // Store module state
        module.getState().put("letters", letters);
        ...
        String solution = possibleWords.get(0);
    ...
    private void setModuleSolution(ModuleEntity module, WordScrambleOutput output) {
