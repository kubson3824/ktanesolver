...
@Service
@ModuleInfo (type = ModuleType.MATH, id = "math", name = "Math", category = ModuleCatalogDto.ModuleCategory.MODDED_REGULAR, description = "Solve math problems", tags = {"puzzle", "visual"})
