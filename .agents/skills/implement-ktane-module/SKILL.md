...
8. Run the focused backend test, relevant Souvenir tests, `npm test -- --run src/services/missionService.test.ts src/utils/twitchCommands.test.ts`, and `npm run build`. Fix failures before continuing.
