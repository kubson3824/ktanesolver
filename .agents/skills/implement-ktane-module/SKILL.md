...
8. Run the focused backend test, relevant Souvenir tests, `npm test -- --run src/utils/twitchCommands.test.ts`, `npm run build`, and `git diff --check`. Fix failures before continuing.
