...
import { solveWordScramble, type WordScrambleInput, type WordScrambleOutput } from "../services/wordScrambleService";
...
export default function WordScrambleSolver({ bomb }: WordScrambleSolverProps) {
  ...
  const [result, setResult] = useState<WordScrambleOutput | null>(null);
